...
namespace Powerless {
  ...
  internal class JoyGiver_LookOutWindow : JoyGiver {
    ...
    public override Job TryGiveJob(Pawn pawn) {
      ...
      glower = GenClosest.ClosestThingReachable(pawn.Position, pawn.Map, ThingRequest.ForDef(ThingDef.Named("POW_WindowGlower")), PathEndMode.OnCell, TraverseParms.For(pawn, Danger.None, TraverseMode.ByPawn, false), 25f, validator) as Building;
